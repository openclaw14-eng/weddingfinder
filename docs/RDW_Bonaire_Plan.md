# RDW Bonaire Vehicle Registration System - Master Plan
...
- **Standard Vehicles:** Cars (personenauto's), Motorcycles/scooters, Trucks (vrachtwagens), Trailers (aanhangwagens)
- **Bonaire-Specific:** Golf carts (very common for local transport), Boats/yachts (marina registration), ATVs/UTVs (off-road vehicles), Construction equipment, Rental fleet vehicles, Electric bikes/golf carts, Classic/vintage cars
...
## License Plate Format (Bonaire-specific)
...
*System: Updates vehicle.current_owner_id, Archives old ownership record, Creates new ownership record, Logs transfer event, Notifies insurance company (if API connected)*
...
**Law Enforcement:** Government contract (free, subsidized by fees)
...
7. API specification for insurance

---

*Plan saved: 2026-02-10 | Author: Ricky & Rimi*